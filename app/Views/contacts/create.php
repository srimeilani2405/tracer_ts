...
<body>
    <div class="container">
        ...
        <form action="<?= base_url('/contacts/store') ?>" method="post" id="contactForm">
            <?= csrf_field() ?>
                ...
                <select name="tahun" id="tahun" required>
                    ...
                    <?php foreach ($tahunOptions as $tahun): ?>
                        <?php if ((int)$tahun >= 2000): ?>
                            <option value="<?= esc($tahun) ?>" <?= old('tahun') == $tahun ? 'selected' : '' ?>>
                                <?= esc($tahun) ?>
                            </option>
                        <?php endif; ?>
                    <?php endforeach; ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="position" id="position" value="<?= old('position') ?? '' ?>" required readonly>
            </div>
            ...
            <div class="form-group conditional-field" id="jurusan-group">
                ...
                <select name="jurusan" id="jurusan">
                    ...
                    <?php foreach ($jurusanOptions as $jurusan): ?>
                        <option value="<?= esc($jurusan['name']) ?>" <?= old('jurusan') == $jurusan['name'] ? 'selected' : '' ?>>
                            <?= esc($jurusan['name']) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group conditional-field" id="program-studi-group">
                ...
                <input type="text" name="program_studi" id="program_studi" value="<?= old('program_studi') ?? '' ?>" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-group">
                    <input type="checkbox" name="show_email" id="show_email" value="1" <?= old('show_email') ? 'checked' : '' ?>>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-group">
                    <input type="checkbox" name="show_phone" id="show_phone" value="1" <?= old('show_phone') ? 'checked' : '' ?>>
