...
<body>
    <div class="container py-4">
        ...
        <form action="<?= site_url('users/store') ?>" method="post">
            ...
            <input type="hidden" name="group" value="alumni">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control <?= session('errors.tahun_kelulusan') ? 'is-invalid' : '' ?>"
                                id="tahun_kelulusan" name="tahun_kelulusan" required>
    ...
    <script>
        $(document).ready(function() {
            // Karena ini halaman khusus alumni, langsung tampilkan field alumni
            $('#alumniFields').show();
